                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: /*HotelAppTheme.buildLightTheme().dividerColor*/ AppColor.activeColor,
                      ),
                    ),
                    child: Material(
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      const BorderRadius.all(Radius.circular(24.0)),
                      border: Border.all(
                        color: /*HotelAppTheme.buildLightTheme().dividerColor*/Colors.pinkAccent,
                      ),
                    ),
                    child: Material(
                      color: Colors.transparent,
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: /*HotelAppTheme.buildLightTheme().primaryColor)*/Colors.black,
            ),
          ),
        ),
      ));
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date)
                                  ? AppColor.activeColor/*HotelAppTheme.buildLightTheme().primaryColor*/
                                  : Colors.transparent,
                              borderRadius:
                              const BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: DateTime.now().day == date.day &&
                                ...
                                ? Colors.white
                                : /*HotelAppTheme.buildLightTheme()
                                .primaryColor*/AppColor.activeColor
                                : Colors.transparent,
